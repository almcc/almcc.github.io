  ...
  return (
    <article>
      <header className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4">{project.frontmatter.description}</p>
        ...
        {project.frontmatter.github && (
          <a
            ...
            className="mt-6 flex items-center gap-3 w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-3 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
          >
            <svg
              viewBox="0 0 24 24"
            ...
            <span className="text-gray-700 dark:text-gray-300 font-mono text-xs">{project.frontmatter.github.replace("https://github.com/", "")}</span>
          </a>
        )}
        {project.frontmatter.url && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 flex items-center gap-3 w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-4 py-3 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
          >
            Website
          </a>
        )}
      ...
      {project.subPages.length > 0 && (
        <nav className="mt-10 border-t border-gray-200 dark:border-gray-800 pt-6">
